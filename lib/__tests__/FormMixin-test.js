...
describe('forms', () => {
  ...
  describe('FormMixin', () => {
    ...
    function assertValid(form) {
      assert.ok(validation.isSuccess(form.state.validation));
    }

    function assertInvalid(form) {
      assert.ok(validation.isFailure(form.state.validation));
    }
    ...
    describe('validation', () => {
      ...
      it('has validationLens', () => {
        assert.ok(form.validationLens());
        assertInvalid(form);
      });
    });
    ...
    describe('value', () => {
      ...
      it('responds when updating value', () => {
        ...
        assert.deepEqual(form.valueLens().val(), 1);
        assertValid(form);
    ...
    describe('callbacks', () => {
      ...
      it('calls onUpdate on new invalid value', () => {
        ...
        assert.deepEqual(
          ...
          [
            -1,
            {validation: {failure: 'invalid value'}},
            undefined
          ]
        );
      });
