...
var {Scalar}          = require('../value/schema');
...
describe('React Forms', () => {
  ...
  describe('<Field /> component', () => {
    ...
    function renderComponent(props) {
      ...
      var field = <Field {...props} value={ref} />;
    ...
    it.skip('reacts on onBlur event', () => {
      renderComponent();
      var input = ReactTestUtils.findRenderedDOMComponentWithTag(component, 'input');
    ...
    describe('validation rendering', () => {
      ...
      it.skip('renders a validation error if value is invalid and dirtied', () => {
        renderComponent({
          value: 'some',
          schema: Scalar({validate: (value) => new Error('validation.failure')})
        });
      ...
      it.skip('renders an external validation error', () => {
        renderComponent({
          externalValidation: ValidationResult('externalValidation.failure')
        });
      ...
      it.skip('renders both validation error and external validation error if value is invalid', () => {
        renderComponent({
          value: 'some',
          schema: Scalar({validate: (value) => new Error('validation.failure')}),
          externalValidation: ValidationResult('externalValidation.failure')
      ...
      it.skip('renders a dirty className if value is valid or invalid and dirtied', () => {
        renderComponent({
          value: 'some'
        });
