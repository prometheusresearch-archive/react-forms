  ...
  describe('Field', () => {
    ...
    describe('input rendering', () => {
      ...
      it('renders into component injected via schema', () => {
        renderComponent({
          schema: <Property input={<textarea />} />,
          value: 42
        });
    ...
    describe('label rendering', () => {
      ...
      it('renders label via schema', () => {
        renderComponent({
          schema: <Property label="label via schema" />
        });
    ...
    describe('validation rendering', () => {
      ...
      it('renders a validation error if value is invalid and dirtied', () => {
        renderComponent({
          value: 'some',
          schema: <Property validate={(value) => 'validation.failure'} />
        });
      ...
      it('renders a dirty className if value is valid or invalid and dirtied', () => {
        ...
        renderComponent({
          value: 'some',
          schema: <Property validate={(value) => false} />
        });
    ...
    describe('hint rendering', () => {
      ...
      it('renders hint via schema', () => {
        renderComponent({
          schema: <Property hint="hint via schema" />
        });
