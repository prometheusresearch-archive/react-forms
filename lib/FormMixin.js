...
var FormStateMixin = {
  ...
  onValueUpdate: function(value) {
    ...
    if (this.props.onUpdate) {
      this.props.onUpdate(nextState.value.value, nextState.value);
    }
    if (this.props.onChange && v.isSuccess(nextState.value.validation)) {
      this.props.onChange(nextState.value.value, nextState.value);
    }
