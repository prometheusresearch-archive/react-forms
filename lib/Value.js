...
class Value {
  ...
  constructor(attributes, onUpdate, root, keyPath, form) {
  ...
  get(key) {
    ...
    return new this.constructor(attributes, this.onUpdate, this.__root, this.keyPath.concat(key), this.form);
  }
  ...
  static create(abstractNode, value, onUpdate, root, form) {
    ...
    var created = new this(attributes, onUpdate, root, null, form);
