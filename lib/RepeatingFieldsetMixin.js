...
var RepeatingFieldsetMixin = {
  ...
  renderFields: function() {
    ...
    var childTemplate = createComponentFromSchema(value.schema.children);
    return value.serialized.map((item, idx) => {
      var child = cloneWithProps(childTemplate, {value: value.get(idx)});
      child.props.key = idx;
      return child;
    });
  },
